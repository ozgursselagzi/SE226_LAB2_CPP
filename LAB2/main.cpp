...
int main() {
    ...
    std::cout << "Words start with 'e: '" << std::endl;
    ...
    std::cout << " " << std::endl;
    std::cout << "Words start with 'ha: '" << std::endl;
    ...
    std::cout << "Please enter a number between 3 and 9 (inclusive): ";
    std::cin >> num;
    ...
    if (num >= 3 && num <= 9) {
        ...
        std::cout << "Invalid input. Please enter a number between 3 and 9 (inclusive)." << std::endl;
    }
